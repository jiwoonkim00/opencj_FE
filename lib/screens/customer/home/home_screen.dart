...
import '../receipt/receipt_camera_screen.dart';
...
class HomeScreen extends StatelessWidget {
                ...
                return Container(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      // 출석 체크 카드
                      _buildAttendanceCard(isChecked, setState, context),

                      const SizedBox(height: 16),

                      // 근처 카페 방문 카드
                      _buildCafeMissionCard(
                          cafeSteps, isChecked, setState, context),

                      const SizedBox(height: 16),

                      // 영수증 인증샷 카드
                      _buildReceiptMissionCard(context),
                    ],
                  ),
                );
              },
  ...
  Widget _buildAttendanceCard(
      bool isChecked, StateSetter setState, BuildContext context) {
    return Container(
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor:
                isChecked ? Colors.orange : Colors.grey[300],
                foregroundColor:
  ...
  // 카페 방문 미션 카드
  Widget _buildCafeMissionCard(int cafeSteps, bool isChecked,
            ...
            child: ElevatedButton(
              onPressed: () {
                if (cafeSteps < 2) {
                  ...
                  if (cafeSteps == 2) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text('카페 방문 미션 완료!')),
                    );
                  }
                }
              },
              style: ElevatedButton.styleFrom(
                backgroundColor:
                cafeSteps == 2 ? Colors.orange : Colors.grey[300],
                foregroundColor:
                cafeSteps == 2 ? Colors.white : Colors.black,
                shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(12)),
                padding: const EdgeInsets.symmetric(vertical: 14),
              ),
  ...
  // 영수증 인증샷 카드
  Widget _buildReceiptMissionCard(BuildContext context) {
    return Container(
      decoration: _cardBoxDecoration(),
      padding: const EdgeInsets.all(20),
      child: Column(
